...
function OneMovieFunc(props) {
  ...
  // As in, if you did the side effect in both of those lifecycle methods in Component class then that would go in the useEffect hook
  // It runs after the component renders - both during the first load and after an update.
  // useEffect takes an optional argument for optimization purposes. This is similar to a this.prevState in Component class
