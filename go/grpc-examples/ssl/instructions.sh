...
openssl genrsa -passout pass:1111 -des3 -out ca.key 4096 # This generates ca.key
openssl req -passin pass:1111 -new -x509 -days 3650 -key ca.key -out ca.crt -subj "/CN=${SERVER_CN}" # This generates the CA trust certificate
