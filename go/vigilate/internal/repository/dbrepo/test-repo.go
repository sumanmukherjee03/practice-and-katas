...
// UpdatePreference updates a site pref
func (m *testDBRepo) UpdatePreference(k string, v string) error {
	return nil
}
...
func (m *testDBRepo) DeleteHost(id int) error {
	return nil
}

func (m *testDBRepo) GetAllHostServiceStatusCount() (int, int, int, int, error) {
	return 0, 0, 0, 0, nil
}

// GetAllHostServicesToMonitor returns a slice of host services
func (m *testDBRepo) GetAllHostServicesToMonitor() ([]*models.HostService, error) {
	var hs []*models.HostService
	return hs, nil
}

// GetAllHostServicesWithStatus returns a slice of host services
func (m *testDBRepo) GetAllHostServicesWithStatus(status string) ([]*models.HostService, error) {
	var hs []*models.HostService
	return hs, nil
}

// GetServiceById gets a service by id and returns models.Service
func (m *testDBRepo) GetServiceById(id int) (models.Service, error) {
	var s models.Service
	return s, nil
}

// AllServices returns a slice of services
func (m *testDBRepo) AllServices() ([]*models.Service, error) {
...
// InsertHostService inserts a host service into the database
func (m *testDBRepo) InsertHostService(hs models.HostService) (int, error) {
	return 1, nil
}
...
// GetHostServiceByHostAndService gets a host service by host id and service id
func (m *testDBRepo) GetHostServiceByHostAndService(hostID, serviceID int) (models.HostService, error) {
	var hs models.HostService
	return hs, nil
}

// InsertEvent inserts an event into the database
func (m *testDBRepo) InsertEvent(e models.Event) (int, error) {
	return 1, nil
}
